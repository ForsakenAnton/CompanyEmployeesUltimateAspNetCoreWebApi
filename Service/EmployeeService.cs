...
internal sealed class EmployeeService : IEmployeeService
{
    ...
    public IEnumerable<EmployeeDto> GetEmployees(Guid companyId, bool trackChanges)
    {
        ...
        var employeesFromDb = _repository.Employee
            .GetEmployees(companyId, trackChanges);

        var employeesDto = _mapper
            .Map<IEnumerable<EmployeeDto>>(employeesFromDb);
    ...
    public EmployeeDto GetEmployee(Guid companyId, Guid id, bool trackChanges)
    {
        ...
        var employeeDb = _repository.Employee
        ...
        bool trackChanges)
    {
        ...
        var employeeEntity = _mapper
            .Map<Employee>(employeeForCreation);
        ...
        var employeeToReturn = _mapper
            .Map<EmployeeDto>(employeeEntity);
    ...
    {
        var company = _repository.Company
            .GetCompany(companyId, compTrackChanges);
        if (company is null)
        {
            throw new CompanyNotFoundException(companyId);
        }
